...
class SeePostsScreen extends StatefulWidget {
  @override
  _SeePostsScreenState createState() => _SeePostsScreenState();
}

class _SeePostsScreenState extends State<SeePostsScreen> {
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        'Showing all posts from Servant and linked Boss accounts',
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 13.0,
                          fontFamily: ('FiraSansExtraCondensed'),
