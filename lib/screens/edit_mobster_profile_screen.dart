...
// //
// // class EditMobsterProfileScreen extends StatelessWidget {
...
// //                         buttonLabel: ('Edit your Servant profile'),
...
// //                                                 ),
// //                                                 child: Text(
// //                                                   'How about each Servant on the app get\'s a paragraph where they can captivate the bosses and increase their chances of being hired and better explain their needs to employers? Yeah...',
// //                                                   style: TextStyle(
// //                                                     color: Colors.white,
// //                                                     fontFamily: ('Ovo'),
// //                                                     fontSize: 13.0,
...
// //                                 //             ),
// //                                 //             child: Text(
// //                                 //               'How about each Mobster on the app get\'s a paragraph where they can captivate the bosses and increase their chances of getting the job they want? Yeah...',
// //                                 //               style: TextStyle(
// //                                 //                 color: Colors.white,
// //                                 //                 fontFamily: ('Ovo'),
// //                                 //                 fontSize: 13.0,
...
// // }
//
// //TODO remove the code above when you finishe this screen
// /// refactor the names to match existing strings & ids
//
...
//
// class EditMobsterProfileScreen extends StatefulWidget {
//   final String cardType;
//
//   final String name;
//   final String skills;
...
//
//   @override
//   _EditMobsterProfileScreenState createState() =>
//       _EditMobsterProfileScreenState();
// }
//
// class _EditMobsterProfileScreenState extends State<EditMobsterProfileScreen> {
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: Text(
                                          'This application does not have a backend and you cannot edit profiles yet. Currently this App is just a front-end portfolio project.',
                                          style: TextStyle(
                                              color: Colors.white,
                                              fontFamily: ('Ovo'),
                                              fontSize: 15.0),
